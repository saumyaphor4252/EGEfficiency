...
./cmsCondorData.py hlt_config_EOR3_v1.py /afs/cern.ch/work/s/ssaumya/private/Egamma/TrackerStudies/CMSSW_14_0_9/src/ /eos/user/s/ssaumya/EGammaHLT/Run3Winter/TrackerStudies/EOR31 -n 15 -q workday -p /afs/cern.ch/user/s/ssaumya/private/x509up_<XYZ>
./sub_total.jobb
...
./cmsCondorData.py hlt_config_EOR3_v2.py /afs/cern.ch/work/s/ssaumya/private/Egamma/TrackerStudies/CMSSW_14_0_9/src/ /eos/user/s/ssaumya/EGammaHLT/Run3Winter/TrackerStudies/EOR32 -n 15 -q workday -p /afs/cern.ch/user/s/ssaumya/private/x509up_<XYZ>
./sub_total.jobb
